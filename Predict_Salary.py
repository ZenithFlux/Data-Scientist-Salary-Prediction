...
rating = st.number_input("Company Rating:", 0., 5., step=.1)
...
if st.radio("Does the company pay hourly?", ["Yes", "No"])=="Yes":
    hourly = 1
else: hourly = 0

st.markdown("Which skills the data scientist possesses?")

data = [[rating, hourly, same_state, st.checkbox("Python"), st.checkbox("R"),
